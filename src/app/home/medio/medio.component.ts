...
export class MedioComponent {
  ...
  public cartas: Carta[] = [
    {estado: false, nombre:"hacha"},
    {estado: false, nombre:"hacha"},
    {estado: false, nombre:"pico"},
    {estado: false, nombre:"pico"},
    {estado: false, nombre:"pala"},
    {estado: false, nombre:"pala"},
    {estado: false, nombre:"destornillador"},
    {estado: false, nombre:"destornillador"},
    {estado: false, nombre:"martillo"},
    {estado: false, nombre:"martillo"},
  ];
      ...
      if(this.cartaElejida != -1){
        if(this.cartas[i].nombre == this.cartas[this.cartaElejida].nombre){
          ...
          if(this.correctas == 5){
            ...
            this.db.agregarTiempoMedio(registro);
          }
        }
        else{
          this.bloqueado = true;
